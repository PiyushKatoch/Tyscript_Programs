var MyRightTriangle = /** @class */ (function () {
    function MyRightTriangle(side1, side2, side3) {
        this.s1 = side1;
        this.s2 = side2;
        this.s3 = side3;
    ...
    MyRightTriangle.isRightAngle = function (s1, s2, s3) {
    ...
    MyRightTriangle.area = function (s1, s2, s3) {
        var h = 0, p = 0, b = 0;
        if (s1 > s2 && s1 > s3) {
            h = s1;
            p = s2;
    ...
    return MyRightTriangle;
}());
var obj4_1 = new MyRightTriangle(3, 4, 5);
var obj4_2 = new MyRightTriangle(3, 4, 3);
